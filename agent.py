...
class Agent:
    ...
    def draw(self, surface):
        ...
        # Drawing path from start state to goal state:
        if self.path:
            for p in self.path:
                pg.draw.circle(surface, pg.Color('blue'), p, 5)
...
class Agent2:
    ...
    def make_img(self):
        ...
        pg.draw.ellipse(img, pg.Color('green'), rect.inflate(-1, -1))
        pg.draw.ellipse(img, pg.Color('pink'), rect.inflate(-10, -10))
